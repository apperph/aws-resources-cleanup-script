...
stacks=$(aws cloudformation list-stacks --region $region --query "StackSummaries[?StackStatus != 'DELETE_COMPLETE'][].{Name: StackName, ID: StackId}" | grep -v "StackSet" --output json)
